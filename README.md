...
Examples:
java -jar ${DSCHECKHOME}/dist/DSCheck.jar --bindDn "cn=Directory Manager" --bindPassword "dmpassword" --instances ds0.example.com:1389~ds1.example.com:1389~ds2.example.com:1389 ${DSCHECKHOME}/tmp/dns.txt
```
